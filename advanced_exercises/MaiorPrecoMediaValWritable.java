...
public class MaiorPrecoMediaValWritable implements WritableComparable<MaiorPrecoMediaValWritable> {

    private double somaValores;
    private int qtd;

    public MaiorPrecoMediaValWritable() {

    }

    public MaiorPrecoMediaValWritable(double somaValores, int qtd) {
    ...
    @Override
    public int compareTo(MaiorPrecoMediaValWritable o) {
    ...
    public boolean equals(Object o) {
        ...
        MaiorPrecoMediaValWritable that = (MaiorPrecoMediaValWritable) o;
