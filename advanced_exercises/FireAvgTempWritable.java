...
public class FireAvgTempWritable
    ...
    public int compareTo(FireAvgTempWritable o) {
        //manter essa implementaçao independente da classe e dos atributos
    ...
    public void readFields(DataInput dataInput) throws IOException {
        //lendo na mesma ordem em que os dadoss foram escritos
    ...
    public boolean equals(Object o) {
        ...
        return Float.compare(that.somaTemperaturas, somaTemperaturas) == 0 && qtd == that.qtd;
    }
